...
data_mob <- filter(data_processed_mobility_us, week!=53)
...
npidata_filter <- npidata %>%
	filter(year+week/52 >= 2020+13/52, year+week/52 <= 2022+46/52)
...
ggsave("figure_mobility.pdf", g1, width=8, height=3)
