...
% Specifically, the model predicted a bimodal peak, with the first peak happening around November 2024.
...
% The SEIR model predicted a larger outbreak that spans over a few more years with a peak occurring at 2025; this prediction further translated to an even longer delay in future outbreaks (Supplementary Figure S3).
